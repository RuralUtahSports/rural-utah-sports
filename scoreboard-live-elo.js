...
function findTeamKey(name){const c=canon(name);return Object.keys(live.teams||{}).find(k=>canon(k)===c)||null}
...
function currentFor(name){const k=findTeamKey(name);return k?live.teams[k]:null}
