(()=>{
  ...
  .rus-export-logo-large.rus-export-logo-tall{max-width:84%;max-height:78px}.rus-export-board.rus-export-landscape .rus-export-logo-large.rus-export-logo-tall{max-width:76%;max-height:48px}
