(()=>{
  ...
  function cloneGame(item,logos){
    ...
    [item.away,item.home].forEach((team,i)=>{
      ...
      const score=teamRows[i].querySelector('.actual');if(!item.teams[i]?.hasActualScore)score?.remove();
