const CACHE='rus-site-20260826-record-alerts1';
const CORE=[
  './',
  './index.html',
  './teams.html',
...
const HTML=/\.html$/i;
const FRESH_HTML=/\/(?:rankings|scoreboard|game|team|team-page-content)\.html$/i;
const FRESH_JS=/(?:pwa|weekly-simulation-promo|home-record-alerts|home-game-of-week|home-feature-share|game-center-upgrade|game-center-color-layout|rankings-sponsor-removal|school-assets-bundle|rus-lines-dashboard|scoreboard-refresh|scoreboard-share-layout|scoreboard-share-layout-core|share-graphic|mobile-shell|nav-menu|team-tabs|team-record-tabs-repair|team-player-records|team-stat-records|team-enhancements|team-enhancements-runtime)\.js$/i;
