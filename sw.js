const CACHE='rus-site-20260921-load-audit1';
const CORE=[
  './',
  './index.html',
  './teams.html',
...
const HTML=/\.html$/i;
const FRESH_HTML=/\/(?:index|rankings|scoreboard|game|team|team-page-content|simulators|playoff-picture|stat-leaders)\.html$/i;
const FRESH_JS=/(?:pwa|weekly-picks|weekly-picks-enhanced|weekly-picks-backend|weekly-simulation-promo|home-this-week|home-record-alerts|home-game-of-week|home-feature-share|site-share|game-center-upgrade|game-center-color-layout|rankings-sponsor-removal|school-assets-bundle|rus-lines-dashboard|scoreboard-refresh|scoreboard-share-layout|scoreboard-share-layout-core|share-graphic|mvp-race-share|mobile-shell|nav-menu|site-search|site-extras|site-share-lite|table-accessibility|app-shell-polish|mobile-optimizations|desktop-optimizations|growth-features|share-preview-links|team-tabs|team-record-tabs-repair|team-player-records|team-stat-records|team-enhancements|team-enhancements-runtime|playoff-picture-v2)\.js$/i;
