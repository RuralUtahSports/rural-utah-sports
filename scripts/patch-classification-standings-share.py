...
q = Path('standings.html')
t = q.read_text(encoding='utf-8')
t = re.sub(r'share-graphic\.js\?v=[^\"\']+', 'share-graphic.js?v=20260816-class-region-share-v1', t)
