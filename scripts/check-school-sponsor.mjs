...
for(const token of ['RUSSchoolAssets','logoUrl','rus-team-page-logo','fetchPriority','fallbackLogo','img.loading'])if(!logo.includes(token))fail(`team-logo-header.js missing ${token}`);
