...
for(const token of ['rus-desktop-layout>#page','rus-side-logo','rus-team-page-logo','rus-team-hero-sponsor','desktop-v2.js?v=20260831-sidebar-currentdata1','DOMContentLoaded','matchMedia'])if(!fixes.includes(token))fail(`team-page-fixes.js missing ${token}`);
for(const token of ['DOMContentLoaded','team-logo-header.js?v=20260819-teamfix2','school-sponsor.js?v=20260819-sponsor4','team-page-fixes.js?v=20260831-sidebar-currentdata1'])if(!loader.includes(token))fail(`team loader missing ${token}`);
...
if(teams.includes('<img class="team-sponsor-logo"'))fail('Teams sponsor logo must not be an img that legacy school-logo integration can overwrite');
