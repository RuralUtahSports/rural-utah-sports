...
def main():
    ...
    for team in teams:
        ...
        streak_output[name] = {
            ...
            'longestScoringStreak': longest_by_score(events, True),
            'currentScoringStreak': current_by_score(events, True),
            'longestShutoutStreak': longest_by_score(events, False),
            'currentShutoutStreak': current_by_score(events, False),
        }
