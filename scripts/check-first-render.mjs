...
for(const token of ['afterFirstPaint','requestAnimationFrame(()=>requestAnimationFrame','requestIdleCallback','afterFirstPaint(loadExtras','afterFirstPaint(setupAnalytics']){
...
for(const token of ['team-enhancements-runtime.js?v=20260819-lcp1','s.async=false','rusTeamEnhancementsRuntime']){
...
if(pwaVersion!=='20260819-lcp1')fail(`Unexpected PWA first-render generation: ${pwaVersion||'missing'}`);
