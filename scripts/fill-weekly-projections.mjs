...
for(const g of feed.games){
  ...
  if(old?.projectionSource==='rus-simulator'&&num(old.awayScore)!==null&&num(old.homeScore)!==null){
  ...
  g.projectionSource='rus-simulator';g.projectionGeneratedAt=now.toISOString();generated++;
}
