...
function loadExtras(){
  if(isScoreboard)add('school-assets-scoreboard.js?v=20260921-load-audit2','rusScoreboardSchoolAssets');
  if(isGame){
...
if(!core)core=add('school-assets-core.js?v=20260925-all-logo-discs1','rusSchoolAssetsCore');
