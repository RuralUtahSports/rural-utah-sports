(()=>{
  ...
  const groups={
    ...
    stats:[['Stat Leaders','stat-leaders.html'],['Weekly Awards','weekly-awards.html'],['Team Stats','team-stats.html'],['MVP Race','mvp-race.html'],['All-Utah Team','all-utah.html'],['All-State & Region Watch','all-state-watch.html'],['Past Award Winners','awards-2025.html']],
    simulators:[['Simulators Hub','simulators.html'],['Promotion / Relegation','promotion-relegation.html']],
    about:[['About RUS','about.html'],['Sponsors','sponsors.html']]
  };
  ...
  function injectStyles(){if(document.getElementById('rus-nav-v2'))return;const style=document.createElement('style');style.id='rus-nav-v2';style.textContent=`
  ...
  async function loadExtras(){
    ...
    addScript('pwa.js?v=20260819-lcp1','rusPwa',true);addScript('site-search.js?v=20260817-player2','rusSiteSearch',true);addScript('optimization-polish.js?v=20260819-lcp1','rusOptimizationPolish',true);addScript('recently-viewed.js?v=20260817-app4','rusRecentlyViewed',true);
    ...
    if(path==='team.html'){addScript('team-dashboard.js?v=20260817a','rusTeamDashboard',true);addScript('team-stats.js?v=20260817c','rusTeamStats',true);addScript('team-overview-cleanup.js?v=20260817a','rusTeamOverviewCleanup',true);addScript('program-timeline.js?v=20260812a','rusProgramTimeline',true);addScript('team-greatest-paths.js?v=20260818-perf1','rusTeamGreatestPaths',true);addScript('team-tabs.js?v=20260818-games1','rusTeamTabs',true);addScript('player-profile-links.js?v=20260814a','rusPlayerProfileLinks',true);if(new URLSearchParams(location.search).get('season')==='2025')addScript('team-season-archive.js?v=20260814a','rusTeamSeasonArchive',false)}
    if(path==='records.html'){addScript('record-watch-filter.js?v=20260815a','rusRecordWatchFilter',true);addScript('uhsaa-record-book.js?v=20260814c','rusUhsaaRecordBook',true);addScript('uhsaa-record-watch.js?v=20260814a','rusUhsaaRecordWatch',true);addScript('records-layout-enhancements.js?v=20260814c','rusRecordsLayoutEnhancements',true)}
    ...
    if(path==='index.html'){addScript('home-personalized.js?v=20260817-app4','rusHomePersonalized',true);addScript('did-you-know.js?v=20260812a','rusDidYouKnow',true);addScript('today-history-more.js?v=20260813a','rusTodayHistoryMore',true);addScript('record-watch-filter.js?v=20260815a','rusRecordWatchFilter',true)}
    if(path.includes('simulator'))[['season-simulator-core.js?v=20260813a','rusSeasonCore'],['season-simulator-odds.js?v=20260813a','rusSeasonOdds'],['season-simulator-score.js?v=20260813e','rusSeasonScore'],['season-simulator-elo.js?v=20260813e','rusSeasonElo'],['season-simulator-run.js?v=20260813e','rusSeasonRun'],['season-simulator-stats.js?v=20260824a','rusSeasonStats'],['season-simulator-view.js?v=20260813h','rusSeasonView'],['season-simulator-ui.js?v=20260813f','rusSeasonUi']].forEach(([src,key])=>addScript(src,key,false));
    if(path==='scoreboard.html'){addScript('mobile-scoreboard-polish.js?v=20260817-final1','rusScoreboardMobilePolish',true);addScript('rus-lines-dashboard.js?v=20260817-app4','rusLinesDashboard',true)}
    ...
    if(path==='all-state-watch.html'){addScript('award-scoring-core.js?v=20260818-defense25','rusAwardScoringCore',false);addScript('all-state-region-order.js?v=20260817-layout','rusAllStateRegionOrder',false)}
  }
  function setup(){injectStyles();const host=document.querySelector('nav .nav-content');if(host){host.classList.add('rus-nav');host.innerHTML=[link('Home','index.html','home-link'),link('Game Week','game-week.html'),link('Teams','teams.html'),link('My Teams','my-teams.html'),link('Games','games.html'),link('Scoreboard','scoreboard.html'),link('Rankings','rankings.html'),link('Standings','standings.html'),dropdown('Stats','stats'),link('Storylines','storylines.html'),dropdown('History','history'),dropdown('Analytics','analytics'),dropdown('Simulators','simulators'),dropdown('About','about')].join('');document.querySelectorAll('.rus-nav details').forEach(d=>d.addEventListener('toggle',()=>{if(!d.open)return;document.querySelectorAll('.rus-nav details').forEach(other=>{if(other!==d)other.open=false})}))}const logo=document.querySelector('header .logo');if(logo&&!logo.closest('a')){logo.classList.add('header-home');logo.setAttribute('title','Home');logo.setAttribute('role','link');logo.setAttribute('tabindex','0');const go=()=>{location.href='index.html'};logo.addEventListener('click',go);logo.addEventListener('keydown',e=>{if(e.key==='Enter'||e.key===' '){e.preventDefault();go()}})}afterFirstPaint(loadExtras,900);afterFirstPaint(setupAnalytics,1800)}
