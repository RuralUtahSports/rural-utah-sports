(()=>{
  ...
  function loadExtras(){
    [['school-assets.js?v=20260813a','rusSchoolAssets'],['school-logo-integration.js?v=20260813b','rusSchoolLogoIntegration'],['site-extras.js','rusExtras'],['site-share.js','rusShare'],['record-watch-filter.js?v=20260812b','rusRecordWatchFilter'],['program-leaderboard-filter.js?v=20260812a','rusProgramLeaderboardFilter'],['history-tools-integration.js?v=20260812c','rusHistoryTools'],['school-colors.js?v=20260813c','rusSchoolColors'],['program-timeline.js?v=20260812a','rusProgramTimeline'],['did-you-know.js?v=20260812a','rusDidYouKnow'],['rivalry-interactive.js?v=20260812a','rusRivalryInteractive'],['team-greatest-paths.js?v=20260812a','rusTeamGreatestPaths'],['elo-explainer.js?v=20260812b','rusEloExplainer'],['team-tabs.js?v=20260813b','rusTeamTabs'],['today-history-more.js?v=20260813a','rusTodayHistoryMore'],['season-simulator-core.js?v=20260813a','rusSeasonCore'],['season-simulator-odds.js?v=20260813a','rusSeasonOdds'],['season-simulator-score.js?v=20260813a','rusSeasonScore'],['season-simulator-elo.js?v=20260813e','rusSeasonElo'],['season-simulator-run.js?v=20260813e','rusSeasonRun'],['season-simulator-view.js?v=20260813h','rusSeasonView'],['season-simulator-ui.js?v=20260813f','rusSeasonUi']].forEach(([src,key])=>{if(document.querySelector(`script[data-${key.replace(/[A-Z]/g,m=>'-'+m.toLowerCase())}]`))return;const s=document.createElement('script');if(src.startsWith('season-simulator-'))s.async=false;s.src=src;s.dataset[key]='1';document.body.appendChild(s)});
    ...
    if(['player.html','mvp-race.html','all-state-watch.html','all-utah.html'].includes(path)&&!document.querySelector('script[data-rus-player-awards]')){const s=document.createElement('script');s.src='player-awards-integration.js?v=20260814a';s.dataset.rusPlayerAwards='1';document.body.appendChild(s)}
    if(path==='stat-leaders.html'&&!document.querySelector('script[data-rus-stat-leaders-branding]')){const s=document.createElement('script');s.src='stat-leaders-branding.js?v=20260814b';s.dataset.rusStatLeadersBranding='1';document.body.appendChild(s)}
    if(path==='map.html'&&!document.querySelector('script[data-rus-map-distance-tools]')){const s=document.createElement('script');s.src='map-distance-tools.js?v=20260814b';s.dataset.rusMapDistanceTools='1';document.body.appendChild(s)}
    if(path==='storylines.html'&&!document.querySelector('script[data-rus-storylines-live-fix]')){const s=document.createElement('script');s.src='storylines-live-fix.js?v=20260814a';s.dataset.rusStorylinesLiveFix='1';document.body.appendChild(s)}
    if(path==='all-state-watch.html'&&!document.querySelector('script[data-rus-all-state-region-order]')){const s=document.createElement('script');s.src='all-state-region-order.js?v=20260814a';s.dataset.rusAllStateRegionOrder='1';document.body.appendChild(s)}
  }
  function setup(){
