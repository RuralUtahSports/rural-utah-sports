(() => {
  ...
  function injectStyles() {
    ...
    style.id = "rus-nav-v2";
    style.textContent = `
    nav{position:relative;z-index:2147482000;overflow:visible!important}.nav-content.rus-nav{display:flex;align-items:stretch;flex-wrap:wrap;gap:0;overflow:visible!important}.rus-nav{overflow:visible!important}.rus-nav>a,.rus-nav details>summary{color:#fff;text-decoration:none;padding:15px 14px;font-size:12px;font-weight:900;text-transform:uppercase;cursor:pointer;list-style:none;display:flex;align-items:center;gap:6px;min-height:48px}.rus-nav details>summary::-webkit-details-marker{display:none}.rus-nav>a:hover,.rus-nav>a.active,.rus-nav details.active>summary,.rus-nav details[open]>summary{background:#F14D07;color:#000}.rus-nav .home-link{padding-inline:13px}.rus-nav details{position:relative}.rus-nav details[open]{z-index:1001}.rus-nav .drop{position:absolute;left:0;top:100%;z-index:1002;min-width:235px;background:#0b0b0b;border:1px solid #333;border-top:3px solid #F14D07;box-shadow:0 10px 24px rgba(0,0,0,.35);display:none;max-height:none;overflow:visible}.rus-nav details[open]>.drop{display:block}.rus-nav .drop a{display:block;color:#fff;text-decoration:none;padding:12px 14px;font-size:12px;font-weight:800;text-transform:uppercase;border-bottom:1px solid #242424;white-space:nowrap}.rus-nav .drop a:last-child{border-bottom:0}.rus-nav .drop a:hover,.rus-nav .drop a.active{background:#F14D07;color:#000}.rus-nav .caret{font-size:10px;transform:translateY(-1px)}.header-home{cursor:pointer}@media(min-width:701px){nav,.nav-content.rus-nav,.rus-nav,.rus-nav details{overflow:visible!important}.rus-nav details:hover>.drop{display:block}.rus-nav details[open]>.drop{display:block;overflow:visible!important;max-height:none!important}}@media(max-width:700px){.nav-content.rus-nav{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.rus-nav>a,.rus-nav details>summary{justify-content:center;text-align:center;padding:12px 7px;font-size:12px}.rus-nav details{position:static}.rus-nav .drop{position:static;grid-column:1/-1;min-width:0;width:100%;box-shadow:none;border-left:0;border-right:0;max-height:none}.rus-nav .drop a{text-align:center;white-space:normal;padding:11px 8px}}
  ...
  async function loadExtras() {
    ...
    if (path === "team.html") {
      ...
      addScript(
        "team-greatest-paths.js?v=20260925-live-rating2",
