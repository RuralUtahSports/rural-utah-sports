(()=>{
  ...
  function loadExtras(){
    ...
    if(path==='stat-leaders.html'&&!document.querySelector('script[data-rus-stat-leaders-branding]')){const s=document.createElement('script');s.src='stat-leaders-branding.js?v=20260814a';s.dataset.rusStatLeadersBranding='1';document.body.appendChild(s)}
    if(path==='map.html'&&!document.querySelector('script[data-rus-map-distance-tools]')){const s=document.createElement('script');s.src='map-distance-tools.js?v=20260814a';s.dataset.rusMapDistanceTools='1';document.body.appendChild(s)}
  }
  function setup(){
